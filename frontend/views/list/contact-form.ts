...
export class ContactForm extends View {   
    ...
    render() {
        ...
        <vaadin-combo-box label="Status" ${field(model.status)} .items=${crmStore.statuses}></vaadin-combo-box>
        <vaadin-combo-box label="Company" ${field(model.company)} .items=${crmStore.companies}></vaadin-combo-box>
