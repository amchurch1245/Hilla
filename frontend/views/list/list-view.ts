...
export class ListView extends View {
  render() {
    ...
    <vaadin-notification theme=${uiStore.message.error ? 'error':'contrast'} position='bottom-start' .opened=${uiStore.message.open} .renderer=${(root:HTMLElement)=>(root.textContent=uiStore.message.text)}>
    </vaadin-notification>
    `;
  }
